    ...
    <div className="space-y-20 pb-20 overflow-hidden relative min-h-screen bg-light-bg dark:bg-navy-deep text-foreground transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <motion.div 
              ...
              className="lg:col-span-5 flex justify-center py-4 lg:-mt-14 lg:mb-0 relative"
            >
              {/* Soft ambient glow background */}
              <div className="absolute -inset-10 bg-linear-to-tr from-brand-pink/15 via-pink-city/10 to-brand-pink-dark/15 blur-[90px] rounded-full pointer-events-none"></div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="text-center pt-8">
          <Link
            href="/faq"
            className="inline-flex items-center space-x-2 px-6 py-3.5 bg-white dark:bg-navy-card border border-light-border dark:border-navy-border/40 text-brand-pink hover:bg-brand-pink hover:text-white font-extrabold rounded-2xl shadow-sm hover:shadow-md transition-all text-xs uppercase tracking-wider"
          >
            <span>{isEn ? "View All Jaipur Metro FAQs & Guide" : "सभी प्रश्न एवं संपूर्ण गाइड देखें"}</span>
            <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </section>
